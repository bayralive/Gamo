...
// 🔥 GLOBAL OPT-IN TO EXPERIMENTAL APIS
    ...
    if (!isAuth) {
        Column(
            ...
            Image(
                ...
                contentDescription = "Bayra Driver Logo",
                        ...
                        Card(
                            ...
                            Row(
                                ...
                                Column {
                                    ...
                                    Text(text = "${job.price} ETB", color = Color(0xFF5E4E92), fontWeight = FontWeight.Black)
                                }
                                Button(
                                    onClick = { 
